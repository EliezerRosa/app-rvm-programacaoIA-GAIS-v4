        ...
        <form onSubmit={handleSubmit} className="flex-grow flex flex-col overflow-hidden">
          <div className="p-6 flex-grow overflow-y-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-6">
              ...
              {/* Coluna 2: Condição e Privilégios */}
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 border-b border-gray-200 dark:border-gray-600 pb-2">Condição e Status</h3>
                 <div>
                ...
                <div>
                 ...
                 <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 border-b border-gray-200 dark:border-gray-600 pb-2 pt-4">Privilégios Gerais (Irmãos)</h3>
               ...
               {/* Coluna 3: Privilégios por Seção e Disponibilidade */}
               <div className="space-y-4">
                    <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 border-b border-gray-200 dark:border-gray-600 pb-2">Privilégios por Seção</h3>
                     <div className="space-y-2">
